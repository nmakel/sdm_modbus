...
class SDM72(SDM):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            "l1_voltage": (0x0000, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 1 line to neutral volts", "V", 1, 1),
            "l2_voltage": (0x0002, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 2 line to neutral volts", "V", 1, 1),
            "l3_voltage": (0x0004, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 3 line to neutral volts", "V", 1, 1),
            "l1_current": (0x0006, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 1 current", "A", 1, 1),
            "l2_current": (0x0008, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 2 current", "A", 1, 1),
            "l3_current": (0x000a, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Phase 3 current", "A", 1, 1),
            ...
            "total_system_va": (0x0038, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Total System VA", "VA", 1, 1),
            "total_system_var": (0x003C, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Total System VAr", "VAr", 1, 1),
            "total_system_power_factor": (0x003E, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Total System Power Factor", "", 1, 1),
            ...
            "resettable_total_energy_active": (0x0180, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Resettalbe Total Energy (Active)", "kWh", 4, 1),
            "resettable_import_enerty_active": (0x0184, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Resettalbe Import Energy (Active)", "kWh", 4, 1),
            "resettable_export_energy_active": (0x0186, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Resettalbe Export Energy (Active)", "kWh", 4, 1),
            "net_kwh": (0x018c, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Net kWh (Import - Export)", "kWh", 4, 1),
