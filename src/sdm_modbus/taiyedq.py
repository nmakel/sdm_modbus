...
class TAC4300_CT(meter.Meter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            ...
            "nature_l1_load": (0x004e, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "L1 Load Nature", "", 1, 1),
            "nature_l2_load": (0x0050, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "L2 Load Nature", "", 1, 1),
            "nature_l3_load": (0x0052, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "L3 Load Nature", "", 1, 1),
            "nature_total_load": (0x0054, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Total Load Nature", "", 1, 1),
            ...
            "maximum_demand_power_active": (0x00a2, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Maximum total system active power demand", "W", 2, 1),
            "maximum_demand_power_active": (0x00a4, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Maximum total system reactive power demand", "VAr", 2, 1),
            "maximum_demand_power_active": (0x00a6, 2, meter.registerType.INPUT, meter.registerDataType.FLOAT32, float, "Maximum total system apparent power demand", "VA", 2, 1),
            ...
            "backlight_time": (0x5019, 1, meter.registerType.HOLDING, meter.registerDataType.UINT16, int, "Backlit time", "min", 1, 1),
            ...
            "software_v": (0x5604, 1, meter.registerType.HOLDING, meter.registerDataType.INT16, int, "Software version number", "", 4, 1),           
            "hardware_v": (0x5605, 1, meter.registerType.HOLDING, meter.registerDataType.INT16, int, "Hardware version number", "", 4, 1),
            "number_of_displayed_v": (0x5606, 1, meter.registerType.HOLDING, meter.registerDataType.INT16, int, "version number of displayed", "", 4, 1)
