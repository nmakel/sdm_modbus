...
class SDM630(SDM):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            ...
            "total_pf": (0x00fe, 2,  registerType.INPUT, registerDataType.FLOAT32, float, "Total system power factor", "Degrees", 3), 
            ...
            "p1_demand_energy_active": (0x015a, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 import active energy", "kWh", 4),
            "p2_demand_energy_active": (0x015c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 import active energy", "kWh", 4),
            "p3_demand_energy_active": (0x015e, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 import active energy", "kWh", 4),
            "p1_import_energy_active": (0x0160, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 export active energy", "kWh", 4),
            "p2_import_energy_active": (0x0162, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 export active energy", "kWh", 4),
            "p3_import_energy_active": (0x0164, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 export active energy", "kWh", 4),
            "p1_energy_active": (0x0166, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 total active energy", "kWh", 4),
            "p2_energy_active": (0x0168, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 total active energy", "kWh", 4),
            "p3_energy_active": (0x016a, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 total active energy", "kWh", 4),
            "p1_demand_energy_reactive": (0x016c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 import reactive energy", "kVArh", 4),
            "p2_demand_energy_reactive": (0x016e, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 import reactive energy", "kVArh", 4),
            "p3_demand_energy_reactive": (0x0170, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 import reactive energy", "kVArh", 4),
            "p1_import_energy_reactive": (0x0172, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 export reactive energy", "kVArh", 4),
            "p2_import_energy_reactive": (0x0174, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 export reactive energy", "kVArh", 4),
            "p3_import_energy_reactive": (0x0176, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 export reactive energy", "kVArh", 4),
            "p1_energy_reactive": (0x0178, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 total reactive energy", "kVArh", 4),
            "p2_energy_reactive": (0x017a, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 total reactive energy", "kVArh", 4),
            "p3_energy_reactive": (0x017c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 total reactive energy", "kVArh",4),
