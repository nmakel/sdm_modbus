...
class SDM230(SDM):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            ...
            "": (0x015c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 import active energy", "kWh", 4),
            "": (0x015e, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 import active energy", "kWh", 4),
            "": (0x0160, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 export active energy", "kWh", 4),
            "": (0x0162, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 export active energy", "kWh", 4),
            "": (0x0164, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 export active energy", "kWh", 4),
            "": (0x0166, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 total active energy", "kWh", 4),
            "": (0x0168, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 total active energy", "kWh", 4),
            "": (0x016a, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 total active energy", "kWh", 4),
            "": (0x016c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 import reactive energy", "kVArh", 4),
            "": (0x016e, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 import reactive energy", "kVArh", 4),
            "": (0x0170, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 import reactive energy", "kVArh", 4),
            "": (0x0172, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 export reactive energy", "kVArh", 4),
            "": (0x0174, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 export reactive energy", "kVArh", 4),
            "": (0x0176, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 export reactive energy", "kVArh", 4),
            "": (0x0178, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 1 total reactive energy", "kVArh", 4),
            "": (0x017a, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 2 total reactive energy", "kVArh", 4),
            "": (0x017c, 2, registerType.INPUT, registerDataType.FLOAT32, float, "Phase 3 total reactive energy", "kVArh",4),
